...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/MwPKoS8dFu)
...
```sh
npx nx serve Algorithm-Visualizer
```

To create a production bundle:

```sh
npx nx build Algorithm-Visualizer
```

To see all available targets to run for a project, run:

```sh
npx nx show project Algorithm-Visualizer
```
